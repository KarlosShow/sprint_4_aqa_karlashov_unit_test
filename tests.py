...
class TestBooksCollector:
    ...
    def test_add_new_book_title_length_validation(self, collector, name):
    ...
    def test_get_books_for_children_returns_suitable_books(self, collector):
    ...
    def test_get_books_for_children_empty_collection_returns_empty_list(self, collector):
        collector.books_genre = {}
        books_for_children = collector.get_books_for_children()
    ...
    def test_add_book_in_favorites_non_existent_book_not_added(self, collector):
